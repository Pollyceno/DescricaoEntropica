...
#-----------PROBABILIDADE CONJUNTA---------------------------------------------------------
	...
	#print(M)
	#OutraCaixa32-241**
	#desig = (h[M.index((0,))]+h[M.index((1,2,6))] - h[M.index((0,1,2,6))]) + (h[M.index((1,))]+h[M.index((3,4,7))] - h[M.index((1,3,4,7))]) + (h[M.index((2,))]+h[M.index((3,))] - h[M.index((2,3))]) -(h[M.index((2,3,4))]- h[M.index((2,3))])
	
	#if(desig >=0.0):
	#print(desig)
	'''
	print('Ix0Ex1y0Z0',(h[M.index((0,))]+h[M.index((1,2,6))] - h[M.index((0,1,2,6))]) )
	print('Ix1Ey1MxZ1',(h[M.index((1,))]+h[M.index((3,4,7))] - h[M.index((1,3,4,7))]) )
	print('Iy0Ey1',(h[M.index((2,))]+h[M.index((3,))] - h[M.index((2,3))]))
	#print('HmxDy0y1', (h[M.index((2,3,4))]- h[M.index((2,3))]))
	'''
	#desig = (h[M.index((2,))]+h[M.index((0,3,6))] - h[M.index((0,2,3,6))]) + (h[M.index((3,))]+h[M.index((1,5,7))] - h[M.index((1,3,5,7))]) + (h[M.index((0,))]+h[M.index((1,))] - h[M.index((0,1))]) - (h[M.index((0,1,5))]- h[M.index((0,1))])
	# (h[M.index((2,))]+h[M.index((0,3,6))] - h[M.index((0,2,3,6))]) + (h[M.index((3,))]+h[M.index((1,5,7))] - h[M.index((1,3,5,7))]) + (h[M.index((0,))]+h[M.index((1,))] - h[M.index((0,1))])
	#print(desig)
	'''
	print('Iy0Ey1x0Z0',(h[M.index((2,))]+h[M.index((0,3,6))] - h[M.index((0,2,3,6))]) )
	print('Iy1Ex1MyZ1',(h[M.index((3,))]+h[M.index((1,5,7))] - h[M.index((1,3,5,7))]) )
	print('Ix0Ex1',(h[M.index((0,))]+h[M.index((1,))] - h[M.index((0,1))]))
	print('Hmxmy', (h[M.index((4,5))]))
	'''

	#PLANETA
	#desig = ((h[M.index((0,))] + h[M.index((2,6))] - h[M.index((0,2,6))])+ (h[M.index((1,))] + h[M.index((3,7))] - h[M.index((1,3,7))]) + (h[M.index((0,1,6))] + h[M.index((2,6))] - h[M.index((0,1,2,6))] - h[M.index((6,))]) + ( h[M.index((0,1,7))] + h[M.index((3,7))] - h[M.index((0,1,3,7))] - h[M.index((7,))]) - h[M.index((4,5))] + (h[M.index((4,))]+h[M.index((5,))]-h[M.index((4,5))]))
	#print(desig)
	'''
	print('Ix0y0z0',(h[M.index((0,))] + h[M.index((2,6))] - h[M.index((0,2,6))]))
	print('Ix1y1z1',(h[M.index((1,))] + h[M.index((3,7))] - h[M.index((1,3,7))]))
	print('Ix0x1y0Dz0',(h[M.index((0,1,6))] + h[M.index((2,6))] - h[M.index((0,1,2,6))] - h[M.index((6,))]))
	print('Ix0x1y1Dz1',(h[M.index((0,1,7))] + h[M.index((3,7))] - h[M.index((0,1,3,7))] - h[M.index((7,))]))
	print('Hm1m2',h[M.index((4,5))])
	print('Im1m2',(h[M.index((4,))]+h[M.index((5,))]-h[M.index((4,5))]))
	'''
	'''
	print('Ix0Ey0z0',(h[M.index((0,))] + h[M.index((2,6))] - h[M.index((0,2,6))]))
	print('Ix0y0Ez0',(h[M.index((0,2))] + h[M.index((6,))] - h[M.index((0,2,6))]))

	print('Ix1Ey1z1',(h[M.index((1,))] + h[M.index((3,7))] - h[M.index((1,3,7))]))
	print('Ix1y1Ez1',(h[M.index((1,3))] + h[M.index((7,))] - h[M.index((1,3,7))]))
	'''

	#OutraCaixa110-199**2
	#desig = h[M.index((0,))] + h[M.index((1,))] + h[M.index((2,))] + h[M.index((3,))] + 0.5*h[M.index((4,))] - h[M.index((0,1))] + 0.5*h[M.index((0,1,4))] + 0.5*h[M.index((0,1,6))] - 0.5*h[M.index((2,3,4))] - 0.5*h[M.index((0,1,2,6))] - 0.5*h[M.index((0,1,4,5))] + 0.5*h[M.index((0,1,4,7))]-0.5*h[M.index((0,1,3,4,7))]
	#print(desig)
